	...
	public static void main(String[] args) {
		...
		while (1 == 1) {
			...
			if (option.equals("add")) {
				...
				Program.adduser(username, score);
				Program.updateScore(username, score);
				...
				Program.incrScore(username);
			}
			Program.printLeaderboard();
			System.out.println("//////////////////////////////");
			Program.printLeaderboardSingleUser(username);
		}
